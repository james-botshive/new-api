-- 资源监控·微信告警 功能集成脚本 (PostgreSQL)
-- Resource Monitor WeChat Alert integration script (PostgreSQL)
--
-- 说明：
...
ALTER TABLE midjourneys ADD COLUMN IF NOT EXISTS token_id bigint DEFAULT 0;
ALTER TABLE midjourneys ADD COLUMN IF NOT EXISTS billing_channel_id bigint DEFAULT 0;
